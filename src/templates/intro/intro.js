...
const Intro = () => {
    ...
    useEffect(() => {
        ...
        gsap.set(element.querySelector(".headline"),{
            opacity: 0.0,
            x:"-=100px"
        })
        gsap.set(element.querySelector(".body"),{
            opacity: 0.0,
            x:"+=100px"
        })
        gsap.timeline({
        ...
        .to(element.querySelector(".headline"),{
            opacity: 1.0,
            x:0,
            ease: 'Circ.easeOut'
        }).to(element.querySelector(".body"),{
            opacity: 1.0,
            x:0,
            ease: 'Circ.easeOut'
        })
    ...
    return(
        <Section ref={ref} id="intro">
            ...
            <Body className="body">
                ...
                <Button to="/contact">Give us a shout</Button>
            </Body>
        </Section>
    );
}
